...
public class GUIManager : MonoBehaviour 
{
	...
	public Texture2D hostSymbolIMG, cheeseIMG, controllerIMG, directionalPadIMG, labMiceTitleIMG;
	...
	public void Start()
	{
		...
		{
			string savedString = PlayerPrefs.GetString(SAVE_SLOT_STRINGS[i]);
			if (savedString != null);
			{
	...
	private void showLevelEditorHelpWindow()
	{
		...
		GUI.Label(new Rect(Screen.width-295,42,290,30), "LEFT CLICK TO REMOVE WALLS.");
		GUI.Label(new Rect(Screen.width-295,72,290,30), "RIGHT CLICK TO ADD WALLS.");
		GUI.Label(new Rect(Screen.width-295,102,290,30), "WASD TO MOVE THE CAMERA.");
	}
	...
	private void showLevelEditorOptionsWindow()
	{
		...
		GUI.Label(new Rect(Screen.width-495,Screen.height-165,490,30), "LEFT CLICK TO REMOVE WALL. RIGHT CLICK TO ADD WALLS.");
